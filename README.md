Since Gnome 41 removed org.gnome.Shell.Eval for security reasons, this is a very small extension to replace switching focus of a window by using something like:
